function HomeViewModel() {
    ...
    var storage = new TAjaxStorage();
    var sections = (storage.getValue()).sections;
    if (sections) {
    ...
    self.productMenuItems = [
        { name: "Laptops & Tablets", isActive: ko.observable(false), url: '#Laptops_Tablets', isLongText: true, categories: data.sections[0].categories },
        { name: "Phones", isActive: ko.observable(false), url: '#Phones', isLongText: false, categories: data.sections[1].categories },
        { name: "Personal Computers", isActive: ko.observable(false), url: '#PersonalComputers', isLongText: true },
        { name: "TV & Cameras", isActive: ko.observable(false), url: '#TV_Cameras', isLongText: true },
        { name: "Gaming", isActive: ko.observable(false), url: '#Gaming', isLongText: false },
        { name: "Software", isActive: ko.observable(false), url: '#Software', isLongText: false }
    ];
